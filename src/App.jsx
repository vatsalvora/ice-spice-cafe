...
const menuData = [
  { category: "Paninis & Sandwiches", emoji: "🥪", items: [
    { name: "Grilled Cheese", price: "$6.49" }, { name: "Paneer Panini", price: "$9.79" },
    { name: "Paneer Tufani", price: "$9.79" }, { name: "Samosa Sandwich", price: "$9.79" },
    { name: "Bombay Sandwich", price: "$8.99" }, { name: "Tomato & Mozz Panini", price: "$8.99" },
    { name: "Chipotle Panini", price: "$8.99" }, { name: "Cali Veggie Panini", price: "$8.99" },
  ]},
  { category: "Chaat & Snacks", emoji: "🌶️", items: [
    { name: "Pav Bhaji", price: "$11.79" }, { name: "Veg Spring Rolls (7 pcs)", price: "$7.49" },
    { name: "Indian Veg Masala Burger", price: "$6.79" }, { name: "Pani Puri", price: "$6.79" },
    { name: "Dahi Puri", price: "$6.79" }, { name: "Samosa", price: "$6.79" },
    { name: "Sev Puri", price: "$6.79" }, { name: "Vada Pav", price: "$6.99" },
    { name: "Bhel Puri", price: "$7.49" }, { name: "Samosa Chaat", price: "$7.49" },
    { name: "Papdi Chaat", price: "$7.49" }, { name: "Aloo Tikki Chaat", price: "$7.49" },
  ]},
  { category: "Fresh Smoothies", emoji: "🥤", items: [
    { name: "ICE Spice Special", price: "$6.49" }, { name: "Hawaiian Lava", price: "$6.49" },
    { name: "Knock Out", price: "$6.49" }, { name: "Peanut Heaven", price: "$6.49" },
    { name: "Lime Berry", price: "$6.49" }, { name: "Island Blue", price: "$6.49" },
    { name: "Tropical Delicious", price: "$6.49" }, { name: "Green Machine", price: "$6.49" },
  ]},
  { category: "Signature Beverages", emoji: "☕", items: [
    { name: "Badam (Almond) Shake", price: "$6.49" }, { name: "Falooda", price: "$6.99" },
    { name: "Chikoo (Sapota) Shake", price: "$6.99" }, { name: "Mango Lassi", price: "$4.29" },
    { name: "Sweet Lassi", price: "$4.29" }, { name: "Salt Lassi", price: "$4.29" },
    { name: "Masala Chai (Tea)", price: "$2.99" }, { name: "Filter Coffee", price: "$2.99" },
  ]},
  { category: "Eggless Ice Creams", emoji: "🍦", items: [
    { name: "Rose (Falooda) Ice Cream", price: "Ask us" }, { name: "Custard Apple (Sitaphal)", price: "Ask us" },
    { name: "Mango Ice Cream", price: "Ask us" }, { name: "Chikoo (Sapota) Ice Cream", price: "Ask us" },
    { name: "RajBhog", price: "Ask us" }, { name: "Sweet Paan Ice Cream", price: "Ask us" },
    { name: "Saffron-Pistachio Ice Cream", price: "Ask us" }, { name: "Pista Kulfi", price: "Ask us" },
    { name: "Rajastani Kulfi", price: "Ask us" },
  ]},
  { category: "Milkshakes", emoji: "🧋", items: [
    { name: "Butterscotch Explosion", price: "$6.49" }, { name: "Mint Chip Milkshake", price: "$6.49" },
    { name: "Strawberries N Cream", price: "$6.49" }, { name: "Coffee (Kahlua Chip)", price: "$6.49" },
    { name: "Brownie Caramel", price: "$6.49" }, { name: "Chocolate Milkshake", price: "$6.49" },
    { name: "Cookies and Cream", price: "$6.49" }, { name: "Birthday Cake Milkshake", price: "$6.49" },
  ]},
]
